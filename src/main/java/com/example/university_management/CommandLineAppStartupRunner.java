...
import com.example.university_management.acl.auth.entity.repository.AuthTypeRepository;
import com.example.university_management.acl.auth.entity.settings.AuthType;
import com.example.university_management.acl.auth.repository.RequestUrlRepository;
...
public class CommandLineAppStartupRunner implements CommandLineRunner {
    ...
    public void createAppBasicRoles() {
        ...
        chkRoleExists = this.roleRepo.getRoleByRoleName("TEACHER");
        if (chkRoleExists == null) {
            Role roleInst2 = new Role("TEACHER", "");
            this.roleRepo.save(roleInst2);
        }

        chkRoleExists = this.roleRepo.getRoleByRoleName("STUDENT");
        if (chkRoleExists == null) {
            Role roleInst3 = new Role("STUDENT", "");
    ...
    public void createAppBasicUsers() throws Exception {
        ...
        if (superAdmin == null) {
            ...
            superAdmin.setPassword(this.bCryptPasswordEncoder.encode("admin"));
            superAdmin.setEmail("emran0744@gmail.com");
